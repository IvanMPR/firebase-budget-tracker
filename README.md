...
This project is my attempt to create something that will resemble the real life app. It is the budget/expense tracker app made with React, with user authentification, with user-friendly interface and real-time synchronization with Firebase, ensuring that data is always up to date.
<br/>
